...
suite("Source File Map", () => {
    test("No Mappings", () => {
        const fileMap = new source_file_map_1.SourceFileMap({});
        const filePaths = [
            "C:\\foo\\src\\bar.c",
            "C:/foo/src/bar.c",
            "/home/foo/src/bar.c",
    ...
    test("Native Path is Local Path", () => {
        ...
        class NativeSourceFileMap extends source_file_map_1.SourceFileMap {
            getNativePathTest() {
                return this.getNativePath();
            }
        }
        const fileMap = new NativeSourceFileMap({});
        if (process.platform == "win32")
            assert.ok(fileMap.getNativePathTest() instanceof path_kind_1.PathWin32);
        else
            assert.ok(fileMap.getNativePathTest() instanceof path_kind_1.PathPosix);
    });
    suite("Local Paths are POSIX", () => {
        class PosixSourceFileMap extends source_file_map_1.SourceFileMap {
            getNativePath() {
                return path_kind_1.PathPosix.getInstance();
            }
        }
        test("Without Trailing Separator", () => {
            const fileMap = new PosixSourceFileMap({
                "C:\\foo": "/home/foo",
                "foo": "home/foo"
            }, "C:\\");
    ...
    suite("Local Paths are Win32", () => {
        class Win32SourceFileMap extends source_file_map_1.SourceFileMap {
            getNativePath() {
                return path_kind_1.PathWin32.getInstance();
            }
        }
        test("Without Trailing Separator", () => {
            const fileMap = new Win32SourceFileMap({
                "/home/foo": "C:\\foo",
                "home/foo": "foo"
            }, "/home");
...
//# sourceMappingURL=source_file_map.test.js.map