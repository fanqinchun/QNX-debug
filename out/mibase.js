...
const os = require("os");
const fs = require("fs");
const source_file_map_1 = require("./source_file_map");
...
class VariableScope {
    constructor(name, threadId, level) {
        this.name = name;
        this.threadId = threadId;
        this.level = level;
    }
    static variableName(handle, name) {
...
class MI2DebugSession extends vscode_debugadapter_1.DebugSession {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (this.useVarObjects) {
                    ...
                    else if (parent instanceof backend_1.VariableObject) {
    ...
    scopesRequest(response, args) {
        ...
        const createScope = (scopeName, expensive) => {
            ...
            return new vscode_debugadapter_1.Scope(scopeName, handle, expensive);
        };
    ...
    variablesRequest(response, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (id instanceof VariableScope) {
                let stack;
                try {
                    stack = yield this.miDebugger.getStackVariables(id.threadId, id.level);
                    for (const variable of stack) {
                        if (this.useVarObjects) {
                            ...
                            if (variable.valueStr !== undefined) {
                                let expanded = (0, gdb_expansion_1.expandValue)(createVariable, `{${variable.name}=${variable.valueStr})`, "", variable.raw);
                                if (expanded) {
                ...
                try {
                    ...
                    try {
                        let expanded = (0, gdb_expansion_1.expandValue)(createVariable, variable.result("value"), id, variable);
                        if (!expanded) {
                ...
                if (id instanceof backend_1.VariableObject) {
                    ...
                    if (varReq.options.arg) {
                        ...
                        const addOne = () => __awaiter(this, void 0, void 0, function* () {
                            ...
                            try {
                                const expanded = (0, gdb_expansion_1.expandValue)(createVariable, variable.result("value"), varReq.name, variable);
                                if (!expanded) {
    ...
    setSourceFileMap(configMap, fallbackGDB, fallbackIDE) {
        if (configMap === undefined) {
            this.sourceFileMap = new source_file_map_1.SourceFileMap({ [fallbackGDB]: fallbackIDE });
        }
        else {
            this.sourceFileMap = new source_file_map_1.SourceFileMap(configMap, fallbackGDB);
        }
    }
}
